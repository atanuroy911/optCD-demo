...
📖 **[Read the full documentation](https://atanuroy911.github.io/optCD-demo/)** — a step-by-step, no-prior-knowledge explanation of how OptCD works, its architecture, how to run it, and findings/limitations from replicating it (once GitHub Pages is enabled for this repo from the `/docs` folder). The original paper is cited there and included at [`docs/OptCD-Optimizing-Continuous-Development.pdf`](docs/OptCD-Optimizing-Continuous-Development.pdf).
